...
var $b14Title = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b14Title"><p class="bHdg">Ruby Hangman:</p></div>');
var $b14Link1 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b14Link1"><p><a href="https://github.com/ncud4bloc/Hangman/" target="_blank">Source Code</a></p></div>');
...
var $b15Title = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b15Title"><p class="bHdg">P51 Motorcycle:</p></div>');
var $b15Link1 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b15Link1"><p><a href="https://github.com/ncud4bloc/My_Frame/" target="_blank">Source Code</a></p></div>');
var $b15Link2 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b15Link2"><p><a href="https://ncud4bloc.github.io/My_Frame/HTML/index.html" target="_blank">View in Browser</a></p></div>');
...
var $b16Title = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b16Title"><p class="bHdg">Mesa Diner:</p></div>');
var $b16Link1 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b16Link1"><p><a href="https://github.com/ncud4bloc/Diner/" target="_blank">Source Code</a></p></div>');
var $b16Link2 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b16Link2"><p><a href="https://ncud4bloc.github.io/Diner/HTML/index.html" target="_blank">View in Browser</a></p></div>');
...
var $b17Title = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b17Title"><p class="bHdg">Image Slider:</p></div>');
var $b17Link1 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b17Link1"><p><a href="https://github.com/ncud4bloc/ImageSlider/" target="_blank">Source Code</a></p></div>');
var $b17Link2 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b17Link2"><p><a href="https://ncud4bloc.github.io/ImageSlider/HTML/index_STD.html" target="_blank">View in Browser</a></p></div>');
...
var $b18Title = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b18Title"><p class="bHdg">Google Map:</p></div>');
var $b18Link1 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b18Link1"><p><a href="https://github.com/ncud4bloc/GoogleMaps/" target="_blank">Source Code</a></p></div>');
var $b18Link2 = $('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 dataPage" id="b18Link2"><p><a href="https://ncud4bloc.github.io/GoogleMaps/HTML/indexGM.html" target="_blank">View in Browser</a></p></div>');
...
$(function(){
    ...
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ){
        console.log('No reload for mobile devices');
    } else {
        $(window).resize(function(){
            location.reload();
        });
